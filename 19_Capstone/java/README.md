...
started..
4. The vending machine is automatically restocked each time the application runs. This 
means you "load" from the file each time the application is run.
...
7. The purchase process flow is as follows
    ...
    * b. Selecting (2) Select Product allows the customer to select a product to
    purchase.
        * i. Show the list of products available and allow the customer to enter the
